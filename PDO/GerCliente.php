            ...
            <div class="mt-3 col-4" style=" margin: 0 auto; width: 400px;">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="txtNascimento" name="txtNascimento" placeholder="Nascimento" value="<?php echo isset($clienteEdit->nascimentoCliente) ? $clienteEdit->nascimentoCliente : null ?>">
                    </div>
                    <div class="form-group">
